...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int p = 3;
        long numEtu = 11500697;
        Random rd = new Random(numEtu); // Création de la suite pseudo-aléatoire à partir d'une graine.
        ...
        time_analysis.save_values("../plots/dynamic_array_time_java_new_strat.plot");
        copy_analysis.save_values("../plots/dynamic_array_copy_java_new_strat.plot");
	    memory_analysis.save_values("../plots/dynamic_array_memory_java_new_strat.plot");
    }
}
