...
int main(int argc, char ** argv){
  ...
  time_analysis.save_values("../plots/dynamic_array_add_and_delete_sqrt_time_p_0.49_cpp.plot");
  copy_analysis.save_values("../plots/dynamic_array_add_and_delete_sqrt_copy_p_0.49_cpp.plot");
  memory_analysis.save_values("../plots/dynamic_array_add_and_delete_sqrt_memory_p_0.49_cpp.plot");
